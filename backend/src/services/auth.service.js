import { createUser, findUserByEmail, findUserWithPasswordByEmail } from "../dao/user.dao.js"
...
export const registerUser = async (name, email, password)=>{
	...
	return {user: {_id: newUser._id, name: newUser.name, email: newUser.email}, token}
}
